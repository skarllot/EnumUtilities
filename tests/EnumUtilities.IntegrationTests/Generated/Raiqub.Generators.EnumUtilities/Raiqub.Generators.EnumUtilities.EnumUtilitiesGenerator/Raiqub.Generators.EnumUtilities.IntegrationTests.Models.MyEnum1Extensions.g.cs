...
namespace Raiqub.Generators.EnumUtilities.IntegrationTests.Models
{
    ...
    {
        /// <summary>Represents the largest possible number of bytes produced by encoding an <see cref="MyEnum1" /> value to UTF-8, based on defined members. This field is constant.</summary>
        ...
        public static bool HasFlagFast(this NestedInClass.MyEnum1 value, NestedInClass.MyEnum1 flag)
        {
        ...
        public static int GetStringCount(this NestedInClass.MyEnum1 value)
        {
            return value switch
            {
                NestedInClass.MyEnum1.Zero => 4,
                NestedInClass.MyEnum1.One => 3,
                NestedInClass.MyEnum1.Two => 3,
        ...
        public static int GetUtf8ByteCount(this NestedInClass.MyEnum1 value)
        {
            return value switch
            {
                NestedInClass.MyEnum1.Zero => 4,
        ...
        public static bool TryWriteString(this NestedInClass.MyEnum1 value, Span<char> destination, out int charsWritten)
        {
            string result = value switch
            {
                NestedInClass.MyEnum1.Zero => "Zero",
                NestedInClass.MyEnum1.One => "One",
                NestedInClass.MyEnum1.Two => "Two",
                _ => value.ToString()
            };
        ...
        /// <returns><see langword="true"/> if the writing was successful; otherwise, <see langword="false"/>.</returns>
        public static bool TryWriteUtf8Bytes(this NestedInClass.MyEnum1 value, Span<byte> destination, out int bytesWritten)
        {
            var bytes = value switch
            {
                NestedInClass.MyEnum1.Zero => "Zero"u8,
                NestedInClass.MyEnum1.One => "One"u8,
                NestedInClass.MyEnum1.Two => "Two"u8,
