...
namespace Raiqub.Generators.EnumUtilities.IntegrationTests.Models
{
    ...
    public static partial class WeekDaysMetadata
    {
        ...
        public static partial class Name
        {
            ...
            /// <summary>Gets a read-only memory containing the members names of <see cref="WeekDays" />.</summary>
            public static ReadOnlyMemory<string> Names => new ReadOnlyMemory<string>(s_names);

            /// <summary>Gets a read-only span containing the members names of <see cref="WeekDays" />.</summary>
