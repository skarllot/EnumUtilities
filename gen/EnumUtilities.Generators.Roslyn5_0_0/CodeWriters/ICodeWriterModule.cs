...
/// <summary>
/// Defines a module that generates a section of source code within an <see cref="ICodeWriter{T}"/>.
/// </summary>
/// <typeparam name="T">The type of the model used for code generation.</typeparam>
public interface ICodeWriterModule<in T>
{
    /// <summary>
    /// Returns the namespace imports required by the source code generated by this module.
    /// </summary>
    /// <param name="model">The model to evaluate.</param>
    /// <returns>A sequence of namespace strings to import.</returns>
    IEnumerable<string> GetNamespacesImports(T model);
